...
def pc_define_number_with_hints():
    ...
    if (residue_by_3 == 0) and (residue_by_7 == 0):
        ...
        print(
            "Hint: This number can be devided by 3 but not by 7. If you devide this number by 7, the residue is {}".format(
                number_to_guess % 7))
    elif (residue_by_3 != 0) and (residue_by_7 == 0):
        print(
            "Hint: This number can be devided by 7 but not by 3. If you devide this number by 3, the residue is {}".format(
                number_to_guess % 3))
    else:
